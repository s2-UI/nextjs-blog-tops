  ...
  return (
    ...
    >
      ...
      <div className='Page FormatingText'>
        ...
        <p>En este espacio, el usuario podrá encontrar toda la información relativa a los términos y condiciones legales que definen las relaciones entre los usuarios y Reviewshub como responsable de esta web. Como usuario, es importante que conozcas estos términos antes de continuar tu navegación.</p>
        <p>https://www.reviewshub.es/ como responsable de esta web, asumo el compromiso de procesar la información de mis usuarios y clientes con plenas garantías y cumplir con los requisitos nacionales y europeos que regulan la recopilación y uso de los datos personales de mis usuarios.</p>
        ...
        <p>Las presentes Condiciones Generales regulan el uso (incluyendo el mero acceso) de las páginas de web, integrantes del sitio web de https://www.reviewshub.es/ incluidos los contenidos y servicios puestos a disposición en ellas. Toda persona que acceda a la web, https://www.reviewshub.es/(“usuario”) acepta someterse a las Condiciones Generales vigentes en cada momento del portal https://www.reviewshub.es/.</p>
        ...
        <p>En la utilización de la web, https://www.reviewshub.es/ el usuario se compromete a no llevar a cabo ninguna conducta que pudiera dañar la imagen, los intereses y los derechos de https://www.reviewshub.es/ o de terceros o que pudiera dañar, inutilizar o sobrecargar el portal https://www.reviewshub.es/ o que impidiera, de cualquier forma, la normal utilización de la web.</p>
        <p>No obstante, el usuario debe ser consciente de que las medidas de seguridad de los sistemas informáticos en Internet no son enteramente fiables y que, por tanto https://www.reviewshub.es/ no puede garantizar la inexistencia de malware u otros elementos que puedan producir alteraciones en los sistemas informáticos (software y hardware) del usuario o en sus documentos electrónicos y ficheros contenidos en los mismos aunque pongo todos los medios necesarios y las medidas de seguridad oportunas para evitar la presencia de estos elementos dañinos.</p>
        ...
        <p>Entre los enlaces facilitados, existe la posibilidad de informar y de referenciar productos y/o servicios y/o infoproductos. En estos últimos casos, esa solicitud será remitida a terceros, como son:</p>
        <ul>
            <li>Amazon, amazon.es</li>
        </ul>
        <p>La información que aparezcan en estos enlaces de afiliados o los anuncios insertados, son facilitados por los propios anunciantes, por lo que https://www.reviewshub.es/ no se hace responsable de posibles inexactitudes o errores que pudieran contener los anuncios, ni garantiza en modo alguno la experiencia, integridad o responsabilidad de los anunciantes o la calidad de sus productos.</p>
        <p>Los anuncios permanecerán publicados en el portal hasta que sean eliminados o suspendidos por parte del anunciante o de https://www.reviewshub.es/, que lógicamente no será responsable de que, una vez dados de baja en sus bases de datos, los anuncios continúen siendo indexados en buscadores ajenos a este portal.</p>
        <p>Cualquier relación contractual o extracontractual que el usuario formalice con los anunciantes, afiliados o terceras personas contactadas a través de este portal se entienden realizados única y exclusivamente entre el usuario y el anunciante y/o tercera persona.</p>
        <p>El usuario sabe y acepta que https://www.reviewshub.es/ únicamente actúa como cauce o medio publicitario y que por tanto no tiene ningún tipo de responsabilidad sobre los daños o perjuicios de cualquier naturaleza ocasionados con motivo de sus negociaciones, conversaciones y/o relaciones contractuales o extracontractuales con los anunciantes o terceras personas físicas o jurídicas contactadas a través de este portal.</p>

        <h2>Medidas de seguridad</h2>
        <p>Los datos personales comunicados por el usuario a https://www.reviewshub.es/ pueden ser almacenados en bases de datos automatizadas o no, cuya titularidad corresponde en exclusiva a https://www.reviewshub.es/, asumiendo ésta todas las medidas de índole técnica, organizativa y de seguridad que garantizan la confidencialidad, integridad y calidad de la información contenida en las mismas de acuerdo con lo establecido en la normativa vigente en protección de datos.La comunicación entre los usuarios y https://www.reviewshub.es/ utiliza un canal seguro, y los datos transmitidos son cifrados gracias a protocolos a https, por tanto, garantizo las mejores condiciones de seguridad para que la confidencialidad de los usuarios esté garantizada.</p>
        ...
        <p>En virtud de lo dispuesto en los artículos 8 y 32.1, párrafo segundo, de la Ley de Propiedad Intelectual, quedan expresamente prohibidas la reproducción, la distribución y la comunicación pública, incluida su modalidad de puesta a disposición, de la totalidad o parte de los contenidos de esta página web, con fines comerciales, en cualquier soporte y por cualquier medio técnico, sin la autorización de https://www.reviewshub.es/. El usuario se compromete a respetar los derechos de Propiedad Intelectual e Industrial titularidad de https://www.reviewshub.es/.</p>
        ...
        <p>En el caso de que un usuario o un tercero consideren que se ha producido una violación de sus legítimos derechos de propiedad intelectual por la introducción de un determinado contenido en la web, deberá notificar dicha circunstancia a https://www.reviewshub.es/ indicando:</p>
        <ul>
        ...
        <p>Las páginas de la web https://www.reviewshub.es/ proporciona enlaces a otros sitios web propios y contenidos que son propiedad de terceros tales como:</p>
        <ul>
            <li>Enlaces de afiliados</li>
        </ul>

        <h2>Exclusión de garantías y responsable</h2>
        <p>https://www.reviewshub.es/ no otorga ninguna garantía ni se hace responsable, en ningún caso, de los daños y perjuicios de cualquier naturaleza que pudieran traer causa de:</p>
        <ul>
        ...
        <p>Con carácter general las relaciones entre https://www.reviewshub.es/ con los usuarios de sus servicios telemáticos, presentes en esta web se encuentran sometidas a la legislación y jurisdicción españolas.</p>

        <h2>Contacto</h2>
        <p>En caso de que cualquier usuario tuviese alguna duda acerca de estas Condiciones legales o cualquier comentario sobre el portal https://www.reviewshub.es/, por favor diríjase a contacto@reviewshub.es</p>
        <p>El aviso legal han sido actualizadas por última vez el 27-02-2023.</p>
      </div>
    </Layout>
  )
}