    ...
    >
      <div className='Page FormatingText'>
        ...
        <div className={styles.TopSection}>
            <Image className={styles.TopSection_image} src="/pexels-cottonbro-studio-4009409.jpg" alt="Imágen de familia viendo la televisión" title="Imágen de familia viendo la televisión" width={524} height={100} />
